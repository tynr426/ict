...
namespace ECF
{
    ...
    public class SpellUtil
    {
        ...
        /// <summary>
        /// Get chinese spell<br/>获得一个字符串的汉语拼音码
        /// 2008-07-31 by shaipe
        /// </summary>
        /// <param name="strText">The STR text.字符串</param>
        /// <returns>System.String汉语拼音码,该字符串只包含大写的英文字母</returns>
                ...
                foreach (char vChar in strText)
                {
                    ...
                    else
                    {
                        if ((int)vChar >= 19968 && (int)vChar <= 40869)
                            ...
                            myStr.Append(strChineseFirstPY[(int)vChar - 19968]); // 对可以查找的汉字计算它的首拼音字母的位置，然后输出
                        else
                            myStr.Append(char.ToUpper(vChar));
                    }
                }
        ...
        /// <summary>
        /// 把汉字转换成拼音(全拼)
        /// 2008-8-24 13:11 by Shaipe
        /// </summary>
        /// <param name="strText">The STR text.</param>
        /// <returns>System.String</returns>
        static public string GetChineseSpells(string strText)
        {
        ...
        /// 2008-8-24 13:11 by Shaipe
        /// </summary>
        /// <param name="cnChar">The cn char.</param>
        /// <returns>System.String</returns>
        ...
        public static string ConvertSpell(string hzString)
        {
            // 匹配中文字符
