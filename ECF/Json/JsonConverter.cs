...
namespace ECF.Json
{
    ...
    public delegate void SetProperties(JsonConverter Property);


    /// <summary>
    ///   <see cref="ECF.Json.JsonConverter"/>
    /// JSON 对象
    /// Author:  XP
    /// Created: 2011/9/7
    /// </summary>
    public class JsonConverter
    {
        ...
        public JsonConverter(SetProperties callback)
        {
            if (callback != null)
            {
                callback(this);
    ...
    /// <summary>
    ///   <see cref="ECF.Json.JsonProperty"/>
    /// json property JSON数据格式之属性
    /// Author:  XP
    /// Created: 2011/9/7
    /// </summary>
    public class JsonProperty
    {
        ...
        /// <param name="jsonString"></param>
        /// <returns></returns>
        private JsonConverter ParseObject(ref String jsonString)
        {
            return new JsonConverter(jsonString);
        }
