...
namespace ECF.Json
{
	...
	/// <summary>
	/// FullName: <see cref="ECF.Json.JsonReader"/>
	/// Summary : JsonReader.cs
	...
	public class JsonReader
    {
		...
		/// <summary>
		/// Gets or sets a value indicating whether [skip non members].
		/// </summary>
		/// <value>
		///   <c>true</c> if [skip non members]; otherwise, <c>false</c>.
		/// </value>
		...
		/// </summary>
		/// <param name="json_text">The json_text.</param>
		...
		public bool Read ()
        {
            ...
            while (true) {
                ...
                try {
                    ...
                    var entry_symbols_1 =
                        parse_table[current_symbol];
                    if (entry_symbols_1.ContainsKey(current_input)){
                        entry_symbols = entry_symbols_1[current_input];
                    }
                    else
                    {
                        entry_symbols = new int[0]; 
                    }
                ...
                if (entry_symbols.Length > 0 && entry_symbols[0] == (int) ParserToken.Epsilon)
                    continue;
