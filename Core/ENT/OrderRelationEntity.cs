...
namespace Core.ENT
{
    ...
    public class OrderRelationEntity : Sdk.BaseEntity
    {
        ...
        private decimal? _UpPayables;
        /// <summary>
        /// 上游支付金额
        /// </summary>
        public decimal? UpPayables
        {
            get { return _UpPayables; }
            set { _UpPayables = value; }
        }
        ...
        private decimal? _DownPayables;
        /// <summary>
        /// 下游支付金额
        /// </summary>
        public decimal? DownPayables
        {
            get { return _DownPayables; }
            set { _DownPayables = value; }
        }
