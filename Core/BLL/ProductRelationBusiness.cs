...
namespace Core.BLL
{
    public class ProductRelationBusiness : CoreBusiness
    {
        public ProductRelationBusiness(IDapperFactory dapperFactory) : base(dapperFactory)
        {
        ...
        public IResultResponse CheckProduct(int sellerId, int dbId, XmlDocument xml)
        {
            ...
            if (relationMappingEntity.GoodsMapping.Count == 0) return ResultResponse.ExceptionResult("上游的货品没有关联上");
