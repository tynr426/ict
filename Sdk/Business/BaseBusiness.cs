...
namespace Sdk.Business
{
    ...
    public abstract class BaseBusiness : IBusiness
    {
        ...
        protected IDapperFactory _dapperFactory;
        public BaseBusiness()
        {
        }
        /// <summary>
        /// 构造实例化.
        /// </summary>
        public BaseBusiness(IDapperFactory dapperFactory)
        {
            dapperFactory.DBKey = DBKey;
            _dapperFactory = dapperFactory;
            DbAccess = new DBAccess(dapperFactory);          
        }
        ...
        public virtual int Delete(string[] ids, object[] paras)
        {
            if (ids.Length > 0)
            {
                return DbAccess.ExecuteDeletes(TableName, ids);
            }
            return 0;
        }
        #endregion
        ...
        public virtual ECF.IEntity GetEntity(int id)
        {
            if (id > 0)
            {
                return DbAccess.GetEntity<IEntity>(TableName, id);
            }
            return null;
        }
        ...
        public virtual ECF.IEntity GetEntity(string condition, DbParameter[] parameters = null)
        {
            ...
            if (!ECF.Utils.IsNullOrEmpty(condition))
            {
                string sql = DbProvider.QueryCommandText(TableName, condition);
        ...
        public virtual ECF.IEntity GetEntity(string tableName, string condition, DbParameter[] parameters = null, string orderby = null, string fields = "*")
        {
            if (!ECF.Utils.IsNullOrEmpty(tableName))
            {
                ...
                return DbAccess.GetEntity<IEntity>(sql, parameters);
            }
            return this.Entity;
        }
        ...
        public virtual ECF.IEntity GetEntity(ConditionParameter[] conditions)
        {
            ...
            {
                string sql = DbProvider.QueryCommandText(TableName,string.Empty);

                return DbAccess.GetEntity<IEntity>(sql, conditions);
        ...
        public virtual ECF.IEntity GetEntity(Dictionary<string, object> conditions)
        {
            if (conditions != null && conditions.Count > 0)
            {
                ...
                string sql = DbProvider.QueryCommandText(TableName, conditions,out parameters);
        ...
        public virtual int LogicDelete(string[] ids, object[] paras)
        {
            ...
            if (ids.Length > 0)
            {
                ...
                return DbAccess.ExecuteNonQuery(sb.ToString());
            }
            return 0;
        }
        #endregion
        ...
        public virtual int StatusUpdate(int status, string codition, object[] paras, DbParameter[] param = null)
        {
            ...
            if (!string.IsNullOrEmpty(codition))
            {
                ...
                return DbAccess.ExecuteNonQuery(sql, param);
            }
            return 0;
        }
        /// <summary>
