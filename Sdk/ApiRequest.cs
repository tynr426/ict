...
namespace Sdk
{
    ...
    {
        private static string AppId = "148fbe3a5d00218a";

        private static string Secret = "8daac14be0948fbb1a692a49e6bd1f0b";
        ...
        public static string GetPaySign(Dictionary<string, string> param)
        {
            param = param ?? new Dictionary<string, string>();
            param = param.ToOrdinalIgnoreCase();
            param.AddItem("appid", AppId);
